...
router.post('/forgot', async (req, res) => {
  try {
    ...
    var resetLink = `${process.env.host}/reset-password/${resetToken}`;
    var mailOptions = {
      from: 'support@everythinghighvibe.com',
      to: existingUser.email,
      subject: 'Password Reset Request',
      text: `Hello, \n\nWe received a request to reset your password. 
      Please click the link below to reset your password: \n\n${resetLink}\n\nIf you did not request this change, 
      please ignore this email.`,
      html: `<p>Hello,</p><p>We received a request to reset your password. 
      Please click the link below to reset your password:</p><p><a href="${resetLink}">Reset Password</a></p>
