  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Become A Everything High Vibe Partner Today!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  ...
                  <h5>Partner with Everything High Vibe to make the world better</h5>
                  <b>Waiting to hear from you!</b>
                </div>
              </Col>
